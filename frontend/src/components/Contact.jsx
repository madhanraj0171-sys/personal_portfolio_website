...
export const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setStatus('error');
      setResponseMsg(err.message || 'Something went wrong while sending message.');
    }
  };
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <a
                    ...
                    className="block p-2 rounded bg-stone-50 border border-stone-200 text-xs sm:text-sm font-medium text-stone-900 hover:text-[#C25E2E] truncate"
                  >
                    {directEmail}
                  </a>
                </div>
                ...
                <div>
                  ...
                  <a
                    ...
                    className="flex items-center justify-between p-2 rounded bg-stone-50 border border-stone-200 text-stone-800 hover:text-[#C25E2E]"
                  >
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 text-sm bg-stone-50 border border-stone-300 rounded-lg focus:outline-none focus:ring-1 focus:ring-[#C25E2E]"
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    disabled={status === 'submitting'}
                    className="w-full px-3 py-2 text-sm bg-stone-50 border border-stone-300 rounded-lg focus:outline-none focus:ring-1 focus:ring-[#C25E2E] resize-y"
                  />
                </div>
