...
import { BookOpen, Code, Layers, Server, Lightbulb } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {interests.map((item) => {
              ...
              return (
                <div
                  key={item.title}
                  className="p-4 rounded-lg bg-stone-50/80 border border-stone-200/90 hover:border-stone-300 transition-colors"
                >
