  ...
  return (
    <header className="sticky top-0 z-40 w-full border-b border-stone-200/80 bg-[#FAF9F6]/95 backdrop-blur-sm">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <a
          href="#home"
          className="flex items-center gap-2.5 font-semibold text-stone-900 hover:text-[#C25E2E] transition-colors group"
        >
          <span className="w-8 h-8 rounded bg-stone-100 border border-stone-200 flex items-center justify-center text-[#C25E2E] group-hover:border-[#C25E2E]/40 transition-colors">
      ...
      {isOpen && (
        <div className="md:hidden border-t border-stone-200 bg-[#FAF9F6] px-4 pt-2 pb-4 space-y-1 shadow-sm">
          ...
          <div className="pt-2 border-t border-stone-200 mt-2 flex items-center justify-between text-xs text-stone-500 px-3">
            <span>Role: Aspiring Software Engineer</span>
          </div>
        </div>
      )}
    </header>
