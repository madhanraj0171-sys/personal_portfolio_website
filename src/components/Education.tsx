      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-sm text-stone-600">
            Current undergraduate degree and foundational academic coursework.
          </p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="p-6 rounded-xl bg-white border border-stone-200/90 shadow-xs relative">
          ...
          <div className="p-5 rounded-lg bg-stone-50/80 border border-stone-200">
            ...
            <p className="mt-2 text-xs text-stone-600">
              Built strong analytical foundations in algebra, trigonometry, calculus, and introductory programming logic.
            </p>
          </div>
        </div>
      </div>
